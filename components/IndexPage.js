                        ...
                        <div className="flex flex-wrap items-center pb-12">
                            <div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
                                <div className="py-2 text-color">
                                    <h1 className="text-2xl lg:text-5xl md:leading-snug tracking-tighter f-f-l font-black">Forget the Oscars, watch these camera-centric films instead</h1>
                                    <h2 className="text-lg lg:text-2xl lg:leading-7 md:leading-10 f-f-r py-4 md:py-8">It's Oscar Sunday, so we've put together a DPReview film festival that celebrates our favorite star - photography!

                                    To keep it simple, we've excluding documentaries, and zeroed on narrative film staring the humble camera. We've also limited this lineup with the hypothetical scenario that if you were to do a one day film festival, what would be a nice mix of films that deliver variety, thrills and perhaps a few surprises.</h2>
                                    <div className="flex items-center cursor-pointer pb-4 md:pb-0">
                                        <h3 className="f-f-r text-lg lg:text-2xl font-semibold underline text-black">Lets Get Started</h3>
                                        <div className="pl-2">
                            ...
                            <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                                ...
                                <div className="relative z-10 bg-white rounded shadow p-6 w-10/12 -mb-20">
                                    ...
                                    <div className="relative mb-3">
                                        ...
                                        <hr className="absolute top-0 h-1 w-7/12 rounded-sm bg-black" />
                                    </div>
                    ...
                    <div className="mx-auto">
                        <div className="flex flex-wrap flex-row-reverse items-center">
                            <div className="md:w-1/2 lg:w-2/3 w-full lg:pl-20 md:pl-10 sm:pl-0 pl-0">
                                <div className="py-2 text-color">
                                    <h1 className="text-2xl lg:text-5xl tracking-tighter md:leading-snug f-f-l font-black">Canon RF 16mm F2.8 STM sample gallery (DPReview TV)</h1>
                                    <h2 className="text-lg lg:text-2xl leading-7 md:leading-10 f-f-r py-8">The Canon RF 16mm F2.8 STM surprised us all with its small size, low price and full frame coverage. Take a look at some photos taken with the very demanding Canon R5. Be sure to download some raw files and let us know what you think!</h2>
                                    <div className="flex items-center cursor-pointer pb-4 md:pb-0">
                                        <h3 className="f-f-r text-lg lg:text-2xl font-semibold underline text-black">Lets Get Started</h3>
                                        <div className="pl-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                            ...
                            <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                                ...
                                <div className="relative z-10 p-4 bg-white shadow rounded mx-auto w-9/12 -mb-20">
                                    ...
                                    <button className="relative focus:outline-none mt-4 py-2 pr-10 bg-black text-white tracking-normal text-xs pl-3 cursor-pointer hover:opacity-90">
                                        View Invoice
